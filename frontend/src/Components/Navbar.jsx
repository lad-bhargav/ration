...
export default function Navbar() {
  return (
    <div className="navbar h-[10vh] p-3 max-w-screen fixed top-0 left-0 w-full bg-white/10 backdrop-blur-md z-50 text-white space-x-4 flex-row gap-9 flex justify-center items-center">
      <div className="w-[30%]">
